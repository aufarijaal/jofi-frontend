...
const JobExperienceCard: React.FC<Props> = ({
  data,
  onDeleteClick,
  onEditClick,
  loading,
  ...
  return (
    <div className="job-experience-item-wrapper flex max-w-md min-w-[400px] gap-2">
      <div
        className="job-experience-item card shadow-lg p-4 relative w-full"
        key={data.id}
      >
        {data.isCurrent && (
        ...
        <h5 className="text-secondary text-xs">at {data.companyName}</h5>
